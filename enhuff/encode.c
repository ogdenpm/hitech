...
int    cmpnp(void const *, void const *);
 ...
 *
 */
int cmpr(register void const * p1, void const * p2) {
	long	i;

	i = (*(chent **)p2)->c_freq - (*(chent **)p1)->c_freq;
	if(i > 0)
		return 1;
	if(i < 0)
		return -1;
 ...
 *
 */
int cmpnp(void const * p1, void const * p2) {

	return ((np *)p1)->np_len - ((np *)p2)->np_len;
}
