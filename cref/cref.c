...
#if __STDC_VERSION__ >= 199901L /* stdbool.h introduced in C99 */
#include <stdbool.h>
#else
...
#if __STDC_VERSION__ < 201112L /* _Noreturn added in C11 */
#define _Noreturn
#endif

/* pre v17.2 MSVC did not define __STDC__ for C11/C17 */
#if !defined(__STDC__) && !defined(__STDC_VERSION__) /* const added in C89 */
#define const
#ifdef HI_TECH_C
